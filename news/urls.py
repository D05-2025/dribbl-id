...
from news.views import show_json, show_json_by_id, add_news_entry_ajax, edit_news_entry_ajax, delete_news, show_news_page, show_news_detail, get_news_json, show_xml, show_xml_by_id
